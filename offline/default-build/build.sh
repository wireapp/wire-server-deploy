...
mkdir -p ${OUTPUT_DIR}/containers-{helm,other,system,adminhost}
...
${TASKS_DIR}/process_charts.sh #IMAGE_EXCLUDE_LIST=""

# all basic chart pre-processing tasks
${TASKS_DIR}/post_chart_process_0.sh
...
${TASKS_DIR}/build_adminhost_containers.sh

# build linux packages
${TASKS_DIR}/build_linux_pkgs.sh

# Creating system containers tarball
${TASKS_DIR}/proc_system_containers.sh

# Processing wire binaries
${TASKS_DIR}/proc_wire_binaries.sh
# --------------------------
